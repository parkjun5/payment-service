...
class TossPaymentExecutorTest(
    ...
    @Test
    fun `should handle correctly various ToosPaymentError scenarios`() {
    ...
    private fun generateErrorScenarios(): List<ErrorScenarios> {
